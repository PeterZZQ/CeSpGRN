...
for interval in [50, 100, 200]:
    for (ngenes, ntfs) in [(20, 5), (30, 10), (50, 20), (100, 50)]:
        ...
        result_dir = "../results_GGM/linear_" + str(ntimes) + "_" + str(interval) + "_" + str(ngenes) + "/"
...
score_all.to_csv("../results_GGM/score_linear_all.csv")
'''
# In[] 
print("------------------------------------------------------------------")
...
score_all.to_csv("../results_GGM/score_linear_diff_all.csv")
'''
...
for interval in [50, 100, 200]:
    ...
    plt.tight_layout()
    fig.savefig("../results_GGM/DynGRN_linear_score_full_interval_" + str(interval) + ".png", bbox_inches = "tight")
    ...
    plt.tight_layout()
    fig.savefig("../results_GGM/DynGRN_linear_score_full_diff_interval_" + str(interval) + ".png", bbox_inches = "tight")    
...
for interval in [50, 100, 200]:
    ...
    plt.tight_layout()
    fig.savefig("../results_GGM/DynGRN_linear_score_full_interval_" + str(interval) + "_tf.png", bbox_inches = "tight")
    ...
    plt.tight_layout()
    fig.savefig("../results_GGM/DynGRN_linear_score_full_diff_interval_" + str(interval) + "_tf.png", bbox_inches = "tight")
